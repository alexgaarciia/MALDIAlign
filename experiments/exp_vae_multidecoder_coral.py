...
def main():
    ...
    results_dir = os.path.join(script_dir, "results_vae_multidecoder_coral")
    ...
    model = MultiVAE_CORAL(input_dim=X_train.shape[1], latent_dim=64, num_domains=2, lr=1e-4, epochs=200, annealing_epochs=100, patience=40)
    ...
    torch.save(model.state_dict(), os.path.join(results_dir, "vae_multidecoder_coral.pth"))
    plot_model_metrics(model, "VAE Multidecoder Coral", save=True, path=results_dir+"/vae_multidecoder_coral_loss")
    ...
    print("====== Saving plots... ======\n")
    plot_tsne_global(tsne_df, per_species=False, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_coral_tsne_global.png")
    plot_tsne_global(tsne_df, per_species=True, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_coral_tsne_global_species.png")
    plot_tsne_global(tsne_df, per_species=True, overlay_per_hospital=True, save=True, path=results_dir + "/vae_multidecoder_coral_tsne_global_species_overlay.png")
    plot_tsne_species(df_all, tsne_results, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_coral_tsne_species.png")
    plot_tsne_species(df_all, tsne_results, overlay_per_hospital=True, save=True, path=results_dir + "/vae_multidecoder_coral_tsne_species_overlay.png")
