...
# ── Diseño factorial: pretrain_lambda × finetune_lambda ───────────────────────
#
#  Pretrain λ ∈ {0.1, 1, 10, 100}  — determina la calidad del z de partida
#  Finetune λ ∈ {0.1, 1, 10, 100}  — determina la presión AMR durante adaptación
#
#  Total combinaciones por modelo_tipo: 4 × 4 = 16
#  Con vae_z y vae_z_annealing: 32 combinaciones por especie
#
# ── Naming convention ─────────────────────────────────────────────────────────
#  Clave en SPECIES_CONFIG: {model_type}_pretlam{X}
#    e.g. "vae_z_pretlam10", "vae_z_annealing_pretlam01"
#
#  Nombre en resultados: {model_type}_pretlam{X}_ftlam{Y}_FT_{mode}_aug{k}
#    e.g. "vae_z_pretlam10_ftlam100_FT_enc_dec_amr_aug1"
#
# ─────────────────────────────────────────────────────────────────────────────
...
SPECIES_CONFIG = {
    ...
    #     "vae_z_pretlam100":          BASE_PATH / "20260606_200940/model.pth",
    #     "vae_z_annealing_pretlam100": BASE_PATH / "20260606_201346/model.pth",
    #     "vae_z_pretlam10":          BASE_PATH / "20260606_185205/model.pth",
    #     "vae_z_annealing_pretlam10": BASE_PATH / "20260606_190030/model.pth",
    #     "vae_z_pretlam1":           BASE_PATH / "20260606_184618/model.pth",
    #     "vae_z_annealing_pretlam1":  BASE_PATH / "20260606_185501/model.pth",
    #     "vae_z_pretlam01":          BASE_PATH / "20260606_184911/model.pth",
    #     "vae_z_annealing_pretlam01": BASE_PATH / "20260606_185742/model.pth",
    # },
    # "Escherichia_Coli": {
    ...
    #     "vae_z_pretlam100":          BASE_PATH / "20260606_201128/model.pth",
    #     "vae_z_annealing_pretlam100": BASE_PATH / "20260607_171734/model.pth",
        # "vae_z_pretlam10":          BASE_PATH / "20260606_185251/model.pth",
        # "vae_z_annealing_pretlam10": BASE_PATH / "20260606_190135/model.pth",
        # "vae_z_pretlam1":           BASE_PATH / "20260606_184706/model.pth",
        # "vae_z_annealing_pretlam1":  BASE_PATH / "20260606_185537/model.pth",
        # "vae_z_pretlam01":          BASE_PATH / "20260606_184958/model.pth",
        # "vae_z_annealing_pretlam01": BASE_PATH / "20260606_185821/model.pth",
    # },
    "Staphylococcus_Aureus": {
        ...
        "vae_z_pretlam100":          BASE_PATH / "20260608_094420/model.pth",
        "vae_z_annealing_pretlam100": BASE_PATH / "20260608_094656/model.pth",
        # "vae_z_pretlam10":          BASE_PATH / "20260606_185321/model.pth",
        # "vae_z_annealing_pretlam10": BASE_PATH / "20260606_190206/model.pth",
        # "vae_z_pretlam1":           BASE_PATH / "20260606_184737/model.pth",
        # "vae_z_annealing_pretlam1":  BASE_PATH / "20260606_185607/model.pth",
        # "vae_z_pretlam01":          BASE_PATH / "20260606_185029/model.pth",
        # "vae_z_annealing_pretlam01": BASE_PATH / "20260606_185851/model.pth",
    },
    ...
    #     "vae_z_pretlam100":          BASE_PATH / "20260606_201319/model.pth",
    #     "vae_z_annealing_pretlam100": BASE_PATH / "20260606_201733/model.pth",
        # "vae_z_pretlam10":          BASE_PATH / "20260606_185415/model.pth",
        # "vae_z_annealing_pretlam10": BASE_PATH / "20260606_190303/model.pth",
        # "vae_z_pretlam1":           BASE_PATH / "20260606_184828/model.pth",
        # "vae_z_annealing_pretlam1":  BASE_PATH / "20260606_185701/model.pth",
        # "vae_z_pretlam01":          BASE_PATH / "20260606_185122/model.pth",
        # "vae_z_annealing_pretlam01": BASE_PATH / "20260606_185947/model.pth",
    # },
    ...
    #     "vae_z_pretlam100":          BASE_PATH / "20260606_201251/model.pth",
    #     "vae_z_annealing_pretlam100": BASE_PATH / "20260606_201700/model.pth",
        # "vae_z_pretlam10":          BASE_PATH / "20260606_185347/model.pth",
        # "vae_z_annealing_pretlam10": BASE_PATH / "20260606_190233/model.pth",
        # "vae_z_pretlam1":           BASE_PATH / "20260606_184802/model.pth",
        # "vae_z_annealing_pretlam1":  BASE_PATH / "20260606_185633/model.pth",
        # "vae_z_pretlam01":          BASE_PATH / "20260606_185055/model.pth",
        # "vae_z_annealing_pretlam01": BASE_PATH / "20260606_185917/model.pth",
    # },
}

# MODEL_KEYS: claves en SPECIES_CONFIG que apuntan a modelos preentrenados
MODEL_KEYS = [
    "vae_z_pretlam100",           "vae_z_annealing_pretlam100",
    # "vae_z_pretlam10",           "vae_z_annealing_pretlam10",
    # "vae_z_pretlam1",            "vae_z_annealing_pretlam1",
    # "vae_z_pretlam01",           "vae_z_annealing_pretlam01",
]

# GRID_FT_LAMBDA: lambdas de finetuning a probar para cada modelo preentrenado
# GRID_FT_LAMBDA = [0.1, 1.0, 10.0, 100.0]
GRID_FT_LAMBDA = [100.0]
...
def get_pretrain_lambda(model_name):
    """Extrae el lambda de pretraining del nombre del modelo."""
    if   "pretlam100" in model_name: return 100.0
    elif "pretlam10"  in model_name: return 10.0
    elif "pretlam1"   in model_name: return 1.0
    elif "pretlam01"  in model_name: return 0.1
    return 100.0

LAMBDA_TAG = {0.1: "01", 1.0: "1", 10.0: "10", 100.0: "100"}

def get_result_name(model_name, ft_lambda, mode, n_amr_samples):
    ft_tag = LAMBDA_TAG[ft_lambda]
    return f"{model_name}_ftlam{ft_tag}_FT_{mode}_aug{n_amr_samples}"
                ...
                for model_name in MODEL_KEYS:
                    ...
                    for mode in FT_MODES:
                        for n_amr_samples in GRID_AMR_SAMPLES:
                            for ft_lambda in GRID_FT_LAMBDA:
                                try:
                                    ...
                                    result_name = get_result_name(
                                        model_name, ft_lambda, mode, n_amr_samples
                                    )
                                    for atb, m in evaluate_amr_head(
                                        ...
                                        row = {
                                            ...
                                            "model": result_name,
                                            "pretrain_lambda": get_pretrain_lambda(model_name),
                                            "finetune_lambda": ft_lambda,
                                            "n_amr_samples": n_amr_samples,
                                            "antibiotic": atb,
                                            "auc": m["auc"],
                                            "pr_auc": m["pr_auc"],
                                    ...
                                    print(f"ERROR {model_name} {mode} ftlam={ft_lambda}: {e}")
