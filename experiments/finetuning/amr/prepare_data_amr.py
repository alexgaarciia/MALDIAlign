...
SPECIES_CONFIG = {
    "Klebsiella_Pneumoniae": {
        "antibiotics": ['Ceftazidime', 'Ceftriaxone', 'Ciprofloxacin', 'Piperacillin-Tazobactam'],
        "dataset_path":   "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final.pkl",
        "source_splits": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260514_101045/data_splits.pkl"),
        "target_pool_size": 3000,
    },
    "Escherichia_Coli": {
        "antibiotics": ['Ampicillin', 'Ceftazidime', 'Ceftriaxone', 'Ciprofloxacin', 'Piperacillin-Tazobactam'],
        "dataset_path":   "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final.pkl",
        "source_splits": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260513_152147/data_splits.pkl"),
    ...
    "Staphylococcus_Aureus": {
        ...
        "source_splits": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260519_103809/data_splits.pkl"),
        "target_pool_size": 6000,
    },
}
