...
from experiments.finetuning.amr.run_finetuning_amr_augmentation import run_finetuning_amr, _count_species
...
SPECIES_CONFIG = {
    ...
    #     "model_path": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260527_223514/model.pth"),
    ...
    #     "splits_dir": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/finetuning/amr/output_data/splits_KlebsiellaPneumoniae_MSUMG_20260527_225533"),
    # },
    "Escherichia_Coli": {
        "antibiotics": ["Ceftazidime", "Ciprofloxacin", "Piperacillin-Tazobactam"],
        "dataset_path": "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final_v3.pkl",
        "model_path": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260527_223855/model.pth"),
        ...
        "splits_dir": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/finetuning/amr/output_data/splits_EscherichiaColi_MSUMG_20260527_225533"),
    },
    "Staphylococcus_Aureus": {
        "antibiotics": ["Oxacillin", "Clindamycin", "Erythromycin"],
        "dataset_path": "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final_v3.pkl",
        "model_path": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260527_224204/model.pth"),
        ...
        "splits_dir": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/finetuning/amr/output_data/splits_StaphylococcusAureus_MSUMG_20260527_225533"),
    },
    # "Enterococcus_Faecium": {
    #     "antibiotics": ["Vancomycin"],
    #     "dataset_path": "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final_v3.pkl",
    #     "model_path": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260527_224514/model.pth"),
    ...
    #     "splits_dir": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/finetuning/amr/output_data/splits_EnterococcusFaecium_MSUMG_20260527_225533"),
    # },
    # "Pseudomonas_Aeruginosa": {
    #     "antibiotics": ["Meropenem", "Amikacin"],
    #     "dataset_path": "/export/usuarios01/agnavarr/MALDIAlign/amr_global_final_v3.pkl",
    #     "model_path": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/results/vae_multidecoder_prior_multiamr/20260527_224359/model.pth"),
    ...
    #     "splits_dir": Path("/export/usuarios01/agnavarr/MALDIAlign/experiments/finetuning/amr/output_data/splits_PseudomonasAeruginosa_MSUMG_20260527_225533"),
    # },
}
...
for species, cfg in SPECIES_CONFIG.items():
    ...
    vae_pretrained = MultiVAE_Bernoulli_SpeciesPrior_AMR_Head_ExtendedZ(
                        ...
                        try:
                            ...
                            for atb, m in metrics_ft.items():
                                all_results.append({
                                    ...
                                    "n_prev": n_prev,
                                    "n_new": n_new,
                                    "model": f"FT_{mode}_aug{n_amr_samples}",
                                    "n_amr_samples":  n_amr_samples,
                                    "antibiotic": atb,
                                    "auc": m["auc"],
                                    "pr_auc": m["pr_auc"],
                                ...
                                print(f"  FT_{mode}_aug{n_amr_samples} {atb}: AUC={m['auc']:.3f}")
...
col_order = (
    ["AMR_head_zero_shot"]
    + [f"FT_{m}_aug{k}" for m in FT_MODES for k in GRID_AMR_SAMPLES]
