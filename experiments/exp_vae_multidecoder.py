...
def main():
    ...
    results_dir = os.path.join(script_dir, "results_vae_multidecoder")
    ...
    model = MultiVAE_Bernoulli_Extended(input_dim=X_train.shape[1], latent_dim=64, num_domains=2, lr=1e-4, epochs=200, annealing_epochs=100, patience=40)
    ...
    torch.save(model.state_dict(), os.path.join(results_dir, "vae_multidecoder.pth"))
    plot_model_metrics(model, "VAE Multidecoder", save=True, path=results_dir+"/vae_multidecoder_loss")
    ...
    print("====== Saving plots... ======\n")
    plot_tsne_global(tsne_df, per_species=False, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_tsne_global.png")
    plot_tsne_global(tsne_df, per_species=True, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_tsne_global_species.png")
    plot_tsne_global(tsne_df, per_species=True, overlay_per_hospital=True, save=True, path=results_dir + "/vae_multidecoder_tsne_global_species_overlay.png")
    plot_tsne_species(df_all, tsne_results, overlay_per_hospital=False, save=True, path=results_dir + "/vae_multidecoder_tsne_species.png")
    plot_tsne_species(df_all, tsne_results, overlay_per_hospital=True, save=True, path=results_dir + "/vae_multidecoder_tsne_species_overlay.png")
