...
class SpeciesCVAE_Bernoulli(nn.Module):
    ...
    explicitly conditioned on species information in both encoder and decoder.
    """
    ...
    def __init__(self, input_dim, latent_dim, n_species):
        ...
        n_species : int
            Number of species used for conditioning.
        """
        super().__init__()
    ...
    def reparameterize(self, mu, logvar):
        """
        Applies the reparameterization trick to sample z ~ q(z | x, species).
        """
    ...
    def forward(self, x, species_onehot):
        """
        Forward pass of the species-conditioned CVAE.
        """
    ...
    def elbo_loss(self, x, mu, logvar, z, species_onehot, beta=1.0):
        """
        Computes the ELBO loss for the species-conditioned CVAE.
        """
...
class SpeciesCVAE_Bernoulli_Extended(SpeciesCVAE_Bernoulli):
    """
    Extended version including optimizer definition, training and validation loops,
