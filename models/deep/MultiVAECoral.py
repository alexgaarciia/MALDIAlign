        ...
        for epoch in range(self.epochs):
            ...
            if (epoch + 1) % 10 == 0:
                print(
                    ...
                    f"[Train] Loss: {train_total_loss:.4f} | Recon: {train_recon_loss:.4f} | KL: {train_kl_loss:.4f} | CORAL: {train_coral_avg:.6f} || "
                    f"[Val] Loss: {val_total_loss:.4f} | Recon: {val_recon_loss:.4f} | KL: {val_kl_loss:.4f} | CORAL: {val_coral_avg:.6f}"
                )
